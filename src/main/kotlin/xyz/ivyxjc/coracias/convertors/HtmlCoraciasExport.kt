...
/**
 * Default CoraciasExport for type HTML.
 * It will use the format result formatted by @see CoraciasFormatter as the tag value
 * and use the type generated by @see CoraciasDataTypeStrategy as the class of the tag.
 *
 * It will just generate one Html table.
 *
 */
